 ...
 *
 *  2018.01.30.
 *  This SDK has been split into separate files for every class it contains.
 *  A namespace has been added to all files to make it possible to autoload the classes.
